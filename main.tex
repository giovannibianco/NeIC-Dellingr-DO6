...
The \dell project has established two temporary trials (pilot) of cross border \einfra resource sharing in order to validate the policies and practicalities. 
...
In total, \BUcons~Billing Units were consumed with \BUreq~Billing Units allocated.
\todo[inline]{PN: Check how much was allocated... or should we tell how much was requested? \\ PN: Remember to update final numbers.}
