...
\todo[inline]{PN: Check the numbers above. How much was granted... or should it be how much was requested? \\
...
\end{center}
\end{table}
\todo[inline]{PN: Remember to update final numbers in Table~\ref{tab:results}.}
