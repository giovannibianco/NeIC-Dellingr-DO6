...
\todo[inline]{PN: In Table~\ref{tab:projects}, are all numbers in the fourth column the allocated resources (and not requested)? \\ PN: In Table~\ref{tab:results}, are all numbers the allocated resources (and not requested)? \\
PN: In Table~\ref{tab:projects}, should Estonia be EST (as in the table) or EE (as in the caption)? \\
PN: I will update FI usage figures in Table~\ref{tab:projects} on 13th March. \\
